...
export function ProgramImage({ program, detail = false }: { program: PublicProgram; detail?: boolean }) {
  if (program.featuredImage) {
    return <Image src={assetPath(program.featuredImage)} alt="" width={1200} height={800} className="h-full w-full object-cover" priority={detail} />;
  }
